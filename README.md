...
### IA
- [ChatGPT](https://chat.openai.com/) -[Claude](https://claude.ai/) - [Microsoft Copilot][(https://m365.cloud.microsoft/chat?auth=2](https://m365.cloud.microsoft/chat)) [Mistral](https://chat.mistral.ai/chat)
